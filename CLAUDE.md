...
CLI tool `vaulto-etf` for Vaulto on-chain basket ETFs. **Read [AGENTS.md](./AGENTS.md)** for the
...
- Install: `npm i -g vaulto-etf-cli` or `npm i -g github:VaultoAI/vaulto-etf-cli`.
